...
\begin{frame}{Compacidad}
   ...
   \vspace{0.3cm}
   \begin{itemize}
      \item $\mathcal{E}$ se dice satisfacible si tiene un modelo.
      \item<2-> $\mathcal{E}$ se dice finitamente satisfacible si todo subconjunto finito de $\mathcal{E}$ tiene un modelo.
   \end{itemize}
\end{frame}
